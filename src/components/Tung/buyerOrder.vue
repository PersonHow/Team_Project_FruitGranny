        ...
        <div class="accordion " id="accordionExample">
            <div class="accordion-item title" v-for="(elements, index) in this.order_num">
                ...
                <h2 class="accordion-header" id="headingOne">
                    ...
                    <!-- 更改狀態的按鈕 -->
                    <button class="checkBtn" type="button" @click="changeCondition(elements.order_id)"
                        :disabled="elements.order_condition === '已完成'">確認收到貨</button>
                </h2>

                <!-- 訂單內容區 -->
                <!-- data-bs-parent="#accordionExample" -->
                <div :id="'collapse' + [index]" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    v-for="item in this.order_num_content">
